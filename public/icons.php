<?php include 'includes/core/document_head.php'?>
		<div id="wrapper" data-adminica-nav-top="3" data-adminica-nav-inner="5" data-adminica-side-top="3" data-adminica-side-inner="5" class="has_fixed_bar">
			...
			<div id="main_container" class="main_container container_16">
			  ...
			  <div class="grid_16 box">
					<h2 class="box_head">Icons <small>- provided by Glyphicons</small></h2>
					<div class="controls">
					...
					<div class="toggle_container">
						<div class="block">
							<div class="columns clearfix" style="padding:20px 0 10px;">
						    <div class="col_25">
						      <ul class="the-icons">
